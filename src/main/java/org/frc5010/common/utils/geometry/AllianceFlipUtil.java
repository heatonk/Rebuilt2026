...
public class AllianceFlipUtil {
  ...
  public static void configure(Distance fieldWidth, Distance fieldLength) {
    AllianceFlipUtil.fieldWidth = fieldWidth;
    AllianceFlipUtil.fieldLength = fieldLength;
  }

  public static double applyX(double x) {
    return shouldFlip() ? fieldLength.magnitude() - x : x;
  }

  public static double applyY(double y) {
    return shouldFlip() ? fieldWidth.magnitude() - y : y;
  }
