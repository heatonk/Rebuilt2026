...
public class ShotCalculator {
  ...
  public static ShotTables createDefaultTables() {
    return new ShotTables(
        ...
        Map.ofEntries(
            Map.entry(1.4156, 89.00),
            Map.entry(2.0796, 89.41),
            Map.entry(2.3645, 95.58),
            Map.entry(2.7649, 97.83),
            Map.entry(3.0481, 99.25),
            Map.entry(3.2195, 100.25),
            Map.entry(3.5309, 103.69),
            Map.entry(3.7474, 105.64),
            Map.entry(3.9269, 107.00),
            Map.entry(4.3173, 109.00),
            Map.entry(4.5403, 111.00),
            Map.entry(4.8099, 113.18),
            Map.entry(5.2494, 116.97),
            Map.entry(5.2859, 115.77),
            Map.entry(5.7789, 120.21),
            Map.entry(6.3521, 126.75),
        ...
        Map.ofEntries(
            ...
            Map.entry(4.10, 1.22),
            Map.entry(5.58, 1.28),
            Map.entry(6.3521, 1.35),
            Map.entry(10.9907, 1.68),
            Map.entry(13.0240, 1.82)),
        0.7,
        100.0,
        0.03);
  }
