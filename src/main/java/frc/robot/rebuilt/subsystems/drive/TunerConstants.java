...
public class TunerConstants {
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(0.060546875);
   ...
   * program.
   *
   * <p>NOTE (5010 deviation from generated output): returns RebuiltDrivetrain (the subclass that
   * adds the rebuilt-side API). Re-apply this single line when regenerating from Tuner X.
   */
  public static RebuiltDrivetrain createDrivetrain() {
    return new RebuiltDrivetrain();
  }
